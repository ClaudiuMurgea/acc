...
Route::group(['middleware' => 'auth','verified','checkRole'], function(Router $router){
    @include('superAdminRoutes.php');
    @include('company/adminRoutes.php');
    @include('facility/adminRoutes.php');
    @include('schedule/scheduleRoutes.php');
});
