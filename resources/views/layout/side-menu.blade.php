    ...
    <div class="flex">
        ...
        <nav class="side-nav">
            <a href="" class="intro-x flex items-center pl-5 pt-4">
                <img alt="{!! env('APP_NAME') !!}" class="w-6" src="{{ asset('dist/images/logo.svg') }}">
           ...
           @if(isset($extra_menu))
            ...
            <div class="side-nav__devider my-6"></div>
                <div class="mt-5">
                    <select class="form-select form-select-sm mt-2" onclick="event.stopPropagation()">
                ...
                <div class="mt-5">
                    <label  class="form-label text-white m-0">Department</label>
                    <select class="form-select form-select-sm mt-2" onclick="event.stopPropagation()">
                ...
                @foreach ($side_menu as $menuKey => $menu)
                    ...
                    @else
                        <li>
                            ...
                            @if (isset($menu['sub_menu']))
                                <ul class="ml-5 {{ $first_level_active_index == $menuKey ? 'side-menu__sub-open' : '' }}">
