    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 2xl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                ...
                <a class="btn btn-primary mt-5" href="{!! route('facility.facilitySteps',auth()->user()->Company->id) !!}">Add Facitlity</a>
                <div class="col-span-12 mt-8">
                    <div class="intro-y flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">Facilities</h2>

                    </div>
                    @if(  !$facilities->count() )
                        <h1 class="text-lg font-medium mr-5 text-primary text-center">There are no facilities</h1>
                    @else
                        <div class="grid grid-cols-12 gap-6 mt-5">

                            @foreach($facilities as $facility)
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <a href="{!! route('facility.dashboard',$facility->id) !!}">
                                        <div class="report-box zoom-in">
                                            <div class="box p-5">
                                                <div class="flex">
                                                    {!! $facility->name !!}
                                                    <div class="ml-auto">
                                                        <div class="report-box__indicator text-primary ">

                                                            <i class="fa fa-home fa-2x text-primary"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="text-base text-slate-500 mt-1">{!! $facility->license_no !!}</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
